<?php
namespace Iamtrungbui\Monrestapi\Controllers;

use Laravel\Lumen\Routing\Controller;
use Iamtrungbui\Monrestapi\FilterBuilders\FilterBuilderManagement;
use Iamtrungbui\Monrestapi\Models\BaseModel;
...
class BaseController extends Controller
{
    ...
    {
        $modelNameSpace = env('MONRESTAPI_MODEL_NAMESPACE', 'App\Models');
